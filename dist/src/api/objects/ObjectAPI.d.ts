...
export default class ObjectAPI {
     ...
     */
    search(query: string, abortSignal: AbortController.signal, searchType?: string): Array<Promise<module>>;
    /**
     ...
     */
    getOriginalPath(identifier: any, path?: any[]): Promise<Array<module>>;
    /**
